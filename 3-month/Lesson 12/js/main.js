...
function render() {
  ...
  for (let i = 0; i < todos.length; i++) {
    const template = todos[i].isEditing
      ? `
      ...
      : `
        <div class="todoCard col-md-3 p-3 ${
          todos[i].isCompleted ? "bg-success text-light" : "bg-light"
        } rounded">
                <div class="form-check form-switch">
                    <input class="form-check-input" type="checkbox" role="switch" id="todo-${
                      todos[i].id
                    }"
                ...
                <div class="d-flex justify-content-end gap-3 mt-4">
                    <button class="btn btn-warning" onclick="toggleEditing(${
                      todos[i].id
                    })">Edit</button>
